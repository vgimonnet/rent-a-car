        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    @php
                        if ($redirect == 'ModifierPersonneMorale') {
                            $redirect = array($redirect, $personne->id_personne_morale);
                        }
                        if (!isset($personne)) {
                            $personne = null;
                        }
                    ...
                    {!! Form::open(['route' => $redirect]) !!}
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            <div class="col-12 col-md-6">
                                ...
                                {{ Form::text('societe', $personne ? $personne->societe : null, ['placeholder' => 'Nom société']) }}
                            </div>
                            <div class="col-12 col-md-6">
                                {{ Form::label('siret', 'N° SIRET') }}
                                {{ Form::text('siret', $personne ? $personne->siret : null, ['placeholder' => 'N° SIRET']) }}
                            </div>
                        </div>
